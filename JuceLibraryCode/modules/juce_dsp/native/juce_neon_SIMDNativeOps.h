...
struct SIMDNativeOps<int8_t>
{
    ...
    static forcedinline bool      allEqual (vSIMDType a, vSIMDType b) noexcept               { return (SIMDNativeOps<int32_t>::sum ((int32x4_t) notEqual (a, b)) == 0); }
...
struct SIMDNativeOps<uint8_t>
{
    ...
    static forcedinline bool      allEqual (vSIMDType a, vSIMDType b) noexcept               { return (SIMDNativeOps<uint32_t>::sum ((uint32x4_t) notEqual (a, b)) == 0); }
